...
{
    // reference : http://stackoverflow.com/questions/19688641/convert-access-image-ole-object-into-raw-image-byte-array-in-c-sharp
    public static class OleImageUnwrap
    {
        public static byte[] GetImageBytesFromOLEField(byte[] oleFieldBytes)
        {
            ...
            try
            {
                ...
                int numberOfBytesToSearch = (oleFieldBytes.Count() < maxNumberOfBytesToSearch
                    ? oleFieldBytes.Count()
                    : maxNumberOfBytesToSearch);
